...
insert into system.query(name, sql) values('SpatialResult.getApplications', 'select id, nr as label, st_asewkb(location) as the_geom from application.application where (office_code = #{office_code} or office_code is null) and ST_Intersects(location, SetSRID(ST_MakeBox3D(ST_Point(#{minx}, #{miny}),ST_Point(#{maxx}, #{maxy})), #{srid}))');
...
insert into system.query(name, sql) values('dynamic.informationtool.get_application', 'select id, nr,  st_asewkb(location) as the_geom from application.application where (office_code = #{office_code} or office_code is null) and ST_Intersects(location, ST_SetSRID(ST_GeomFromWKB(#{wkb_geom}), #{srid}))');
...
ALTER TABLE administrative.notation ADD CONSTRAINT notation_ba_unit_id_fk78 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE Cascade;
CREATE INDEX notation_ba_unit_id_fk78_ind ON administrative.notation (ba_unit_id);

ALTER TABLE administrative.ba_unit_area ADD CONSTRAINT ba_unit_area_ba_unit_id_fk79 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_area_ba_unit_id_fk79_ind ON administrative.ba_unit_area (ba_unit_id);
...
ALTER TABLE administrative.ba_unit_target ADD CONSTRAINT ba_unit_target_ba_unit_id_fk117 
            FOREIGN KEY (ba_unit_id) REFERENCES administrative.ba_unit(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX ba_unit_target_ba_unit_id_fk117_ind ON administrative.ba_unit_target (ba_unit_id);
...
ALTER TABLE system.office ADD CONSTRAINT office_district_code_fk128 
            FOREIGN KEY (district_code) REFERENCES system.district(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX office_district_code_fk128_ind ON system.office (district_code);

ALTER TABLE system.vdc ADD CONSTRAINT vdc_district_code_fk129 
            FOREIGN KEY (district_code) REFERENCES system.district(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX vdc_district_code_fk129_ind ON system.vdc (district_code);

ALTER TABLE system.department ADD CONSTRAINT department_office_code_fk130 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX department_office_code_fk130_ind ON system.department (office_code);

ALTER TABLE system.appuser ADD CONSTRAINT appuser_department_code_fk131 
            FOREIGN KEY (department_code) REFERENCES system.department(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX appuser_department_code_fk131_ind ON system.appuser (department_code);
...
ALTER TABLE administrative.ba_unit ADD CONSTRAINT ba_unit_loc_id_fk133 
            FOREIGN KEY (loc_id) REFERENCES administrative.land_owner_certificate(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_loc_id_fk133_ind ON administrative.ba_unit (loc_id);

ALTER TABLE administrative.moth ADD CONSTRAINT moth_vdc_code_fk134 
            FOREIGN KEY (vdc_code) REFERENCES system.vdc(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX moth_vdc_code_fk134_ind ON administrative.moth (vdc_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_map_sheet_id_fk135 
            FOREIGN KEY (map_sheet_id) REFERENCES cadastre.map_sheet(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_map_sheet_id_fk135_ind ON cadastre.cadastre_object (map_sheet_id);

ALTER TABLE source.source ADD CONSTRAINT source_office_code_fk136 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_office_code_fk136_ind ON source.source (office_code);

ALTER TABLE document.document ADD CONSTRAINT document_office_code_fk137 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX document_office_code_fk137_ind ON document.document (office_code);

ALTER TABLE source.source ADD CONSTRAINT source_maintype_fk138 
            FOREIGN KEY (maintype) REFERENCES source.presentation_form_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_maintype_fk138_ind ON source.source (maintype);

ALTER TABLE source.source ADD CONSTRAINT source_archive_id_fk139 
            FOREIGN KEY (archive_id) REFERENCES source.archive(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_archive_id_fk139_ind ON source.source (archive_id);
