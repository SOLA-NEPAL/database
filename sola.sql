...
ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_parcel_type_fk120 
            FOREIGN KEY (parcel_type) REFERENCES cadastre.parcel_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX cadastre_object_parcel_type_fk120_ind ON cadastre.cadastre_object (parcel_type);

ALTER TABLE cadastre.construction ADD CONSTRAINT construction_constype_fk121 
            FOREIGN KEY (constype) REFERENCES cadastre.construction_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX construction_constype_fk121_ind ON cadastre.construction (constype);

ALTER TABLE cadastre.segments ADD CONSTRAINT segments_mbound_type_fk122 
            FOREIGN KEY (mbound_type) REFERENCES cadastre.map_boundary_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX segments_mbound_type_fk122_ind ON cadastre.segments (mbound_type);

ALTER TABLE cadastre.segments ADD CONSTRAINT segments_abound_type_fk123 
            FOREIGN KEY (abound_type) REFERENCES cadastre.adminstrative_boundary_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX segments_abound_type_fk123_ind ON cadastre.segments (abound_type);

ALTER TABLE cadastre.segments ADD CONSTRAINT segments_bound_type_fk124 
            FOREIGN KEY (bound_type) REFERENCES cadastre.boundary_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX segments_bound_type_fk124_ind ON cadastre.segments (bound_type);

ALTER TABLE administrative.loc ADD CONSTRAINT loc_moth_id_fk125 
            FOREIGN KEY (moth_id) REFERENCES administrative.moth(id) ON UPDATE Cascade ON DELETE Cascade;
CREATE INDEX loc_moth_id_fk125_ind ON administrative.loc (moth_id);

ALTER TABLE system.office ADD CONSTRAINT office_district_code_fk126 
            FOREIGN KEY (district_code) REFERENCES system.district(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX office_district_code_fk126_ind ON system.office (district_code);

ALTER TABLE system.vdc ADD CONSTRAINT vdc_district_code_fk127 
            FOREIGN KEY (district_code) REFERENCES system.district(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX vdc_district_code_fk127_ind ON system.vdc (district_code);
...
ALTER TABLE system.appuser ADD CONSTRAINT appuser_department_code_fk129 
            FOREIGN KEY (department_code) REFERENCES system.department(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX appuser_department_code_fk129_ind ON system.appuser (department_code);
...
ALTER TABLE administrative.moth ADD CONSTRAINT moth_vdc_code_fk131 
            FOREIGN KEY (vdc_code) REFERENCES system.vdc(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX moth_vdc_code_fk131_ind ON administrative.moth (vdc_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_map_sheet_id_fk132 
            FOREIGN KEY (map_sheet_id) REFERENCES cadastre.map_sheet(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_map_sheet_id_fk132_ind ON cadastre.cadastre_object (map_sheet_id);

ALTER TABLE source.source ADD CONSTRAINT source_office_code_fk133 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_office_code_fk133_ind ON source.source (office_code);

ALTER TABLE document.document ADD CONSTRAINT document_office_code_fk134 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX document_office_code_fk134_ind ON document.document (office_code);
