...
>>>>>>> aced7efb4503a58e5ac89c4f09135f2add40e48c
    rowidentifier varchar(40) NOT NULL DEFAULT (uuid_generate_v1()),
    rowversion integer NOT NULL DEFAULT (0),
    change_action char(1) NOT NULL DEFAULT ('i'),
    change_user varchar(50),
...
ALTER TABLE administrative.moth ADD CONSTRAINT moth_vdc_code_fk129 
            FOREIGN KEY (vdc_code) REFERENCES system.vdc(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX moth_vdc_code_fk129_ind ON administrative.moth (vdc_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_map_sheet_id_fk130 
            FOREIGN KEY (map_sheet_id) REFERENCES cadastre.map_sheet(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_map_sheet_id_fk130_ind ON cadastre.cadastre_object (map_sheet_id);

ALTER TABLE source.source ADD CONSTRAINT source_office_code_fk131 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_office_code_fk131_ind ON source.source (office_code);

ALTER TABLE document.document ADD CONSTRAINT document_office_code_fk132 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX document_office_code_fk132_ind ON document.document (office_code);

ALTER TABLE source.source ADD CONSTRAINT source_maintype_fk133 
            FOREIGN KEY (maintype) REFERENCES source.presentation_form_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_maintype_fk133_ind ON source.source (maintype);

ALTER TABLE source.source ADD CONSTRAINT source_archive_id_fk134 
            FOREIGN KEY (archive_id) REFERENCES source.archive(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_archive_id_fk134_ind ON source.source (archive_id);

ALTER TABLE party.party ADD CONSTRAINT party_office_code_fk135 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_office_code_fk135_ind ON party.party (office_code);

ALTER TABLE administrative.ba_unit ADD CONSTRAINT ba_unit_office_code_fk136 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_office_code_fk136_ind ON administrative.ba_unit (office_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_office_code_fk137 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_office_code_fk137_ind ON cadastre.cadastre_object (office_code);

ALTER TABLE application.application ADD CONSTRAINT application_office_code_fk138 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_office_code_fk138_ind ON application.application (office_code);

ALTER TABLE system.br ADD CONSTRAINT br_office_code_fk139 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_office_code_fk139_ind ON system.br (office_code);

ALTER TABLE system.setting ADD CONSTRAINT setting_office_code_fk140 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX setting_office_code_fk140_ind ON system.setting (office_code);

ALTER TABLE administrative.moth ADD CONSTRAINT moth_office_code_fk141 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX moth_office_code_fk141_ind ON administrative.moth (office_code);

ALTER TABLE administrative.loc ADD CONSTRAINT loc_office_code_fk142 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX loc_office_code_fk142_ind ON administrative.loc (office_code);

ALTER TABLE cadastre.map_sheet ADD CONSTRAINT map_sheet_office_code_fk143 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX map_sheet_office_code_fk143_ind ON cadastre.map_sheet (office_code);

ALTER TABLE transaction.transaction ADD CONSTRAINT transaction_office_code_fk144 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX transaction_office_code_fk144_ind ON transaction.transaction (office_code);

ALTER TABLE address.address ADD CONSTRAINT address_vdc_code_fk145 
            FOREIGN KEY (vdc_code) REFERENCES system.vdc(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX address_vdc_code_fk145_ind ON address.address (vdc_code);

ALTER TABLE party.party ADD CONSTRAINT party_photo_id_fk146 
            FOREIGN KEY (photo_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_photo_id_fk146_ind ON party.party (photo_id);

ALTER TABLE party.party ADD CONSTRAINT party_left_finger_id_fk147 
            FOREIGN KEY (left_finger_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_left_finger_id_fk147_ind ON party.party (left_finger_id);

ALTER TABLE party.party ADD CONSTRAINT party_right_finger_id_fk148 
            FOREIGN KEY (right_finger_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_right_finger_id_fk148_ind ON party.party (right_finger_id);

ALTER TABLE party.party ADD CONSTRAINT party_signature_id_fk149 
            FOREIGN KEY (signature_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_signature_id_fk149_ind ON party.party (signature_id);

ALTER TABLE cadastre.cadastre_object_target ADD CONSTRAINT cadastre_object_target_office_code_fk150 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
