...
ALTER TABLE cadastre.legal_space_utility_network ADD CONSTRAINT legal_space_utility_network_status_code_fk27 
            FOREIGN KEY (status_code) REFERENCES cadastre.utility_network_status_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX legal_space_utility_network_status_code_fk27_ind ON cadastre.legal_space_utility_network (status_code);

ALTER TABLE cadastre.legal_space_utility_network ADD CONSTRAINT legal_space_utility_network_type_code_fk28 
            FOREIGN KEY (type_code) REFERENCES cadastre.utility_network_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX legal_space_utility_network_type_code_fk28_ind ON cadastre.legal_space_utility_network (type_code);

ALTER TABLE application.request_type ADD CONSTRAINT request_type_request_category_code_fk29 
            FOREIGN KEY (request_category_code) REFERENCES application.request_category_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX request_type_request_category_code_fk29_ind ON application.request_type (request_category_code);

ALTER TABLE application.service ADD CONSTRAINT service_application_id_fk30 
            FOREIGN KEY (application_id) REFERENCES application.application(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX service_application_id_fk30_ind ON application.service (application_id);

ALTER TABLE application.service ADD CONSTRAINT service_request_type_code_fk31 
            FOREIGN KEY (request_type_code) REFERENCES application.request_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX service_request_type_code_fk31_ind ON application.service (request_type_code);

ALTER TABLE party.party_role ADD CONSTRAINT party_role_type_code_fk32 
            FOREIGN KEY (type_code) REFERENCES party.party_role_type(code) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX party_role_type_code_fk32_ind ON party.party_role (type_code);

ALTER TABLE party.party_role ADD CONSTRAINT party_role_party_id_fk33 
            FOREIGN KEY (party_id) REFERENCES party.party(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX party_role_party_id_fk33_ind ON party.party_role (party_id);

ALTER TABLE application.application ADD CONSTRAINT application_agent_id_fk34 
            FOREIGN KEY (agent_id) REFERENCES party.party(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_agent_id_fk34_ind ON application.application (agent_id);

ALTER TABLE party.party ADD CONSTRAINT party_address_id_fk35 
            FOREIGN KEY (address_id) REFERENCES address.address(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_address_id_fk35_ind ON party.party (address_id);

ALTER TABLE cadastre.spatial_unit_address ADD CONSTRAINT spatial_unit_address_address_id_fk36 
            FOREIGN KEY (address_id) REFERENCES address.address(id) ON UPDATE CASCADE ON DELETE CASCADE;
CREATE INDEX spatial_unit_address_address_id_fk36_ind ON cadastre.spatial_unit_address (address_id);

ALTER TABLE cadastre.spatial_unit ADD CONSTRAINT spatial_unit_dimension_code_fk37 
            FOREIGN KEY (dimension_code) REFERENCES cadastre.dimension_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX spatial_unit_dimension_code_fk37_ind ON cadastre.spatial_unit (dimension_code);

ALTER TABLE party.party ADD CONSTRAINT party_preferred_communication_code_fk38 
            FOREIGN KEY (preferred_communication_code) REFERENCES party.communication_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_preferred_communication_code_fk38_ind ON party.party (preferred_communication_code);

ALTER TABLE application.application ADD CONSTRAINT application_contact_person_id_fk39 
...
ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_parcel_type_fk118 
            FOREIGN KEY (parcel_type) REFERENCES cadastre.parcel_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX cadastre_object_parcel_type_fk118_ind ON cadastre.cadastre_object (parcel_type);

ALTER TABLE cadastre.construction ADD CONSTRAINT construction_constype_fk119 
            FOREIGN KEY (constype) REFERENCES cadastre.construction_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX construction_constype_fk119_ind ON cadastre.construction (constype);

ALTER TABLE cadastre.segments ADD CONSTRAINT segments_mbound_type_fk120 
            FOREIGN KEY (mbound_type) REFERENCES cadastre.map_boundary_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX segments_mbound_type_fk120_ind ON cadastre.segments (mbound_type);

ALTER TABLE cadastre.segments ADD CONSTRAINT segments_abound_type_fk121 
            FOREIGN KEY (abound_type) REFERENCES cadastre.adminstrative_boundary_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX segments_abound_type_fk121_ind ON cadastre.segments (abound_type);

ALTER TABLE cadastre.segments ADD CONSTRAINT segments_bound_type_fk122 
            FOREIGN KEY (bound_type) REFERENCES cadastre.boundary_type(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX segments_bound_type_fk122_ind ON cadastre.segments (bound_type);

ALTER TABLE administrative.loc ADD CONSTRAINT loc_moth_id_fk123 
            FOREIGN KEY (moth_id) REFERENCES administrative.moth(id) ON UPDATE Cascade ON DELETE Cascade;
CREATE INDEX loc_moth_id_fk123_ind ON administrative.loc (moth_id);

ALTER TABLE system.office ADD CONSTRAINT office_district_code_fk124 
            FOREIGN KEY (district_code) REFERENCES system.district(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX office_district_code_fk124_ind ON system.office (district_code);

ALTER TABLE system.vdc ADD CONSTRAINT vdc_district_code_fk125 
            FOREIGN KEY (district_code) REFERENCES system.district(code) ON UPDATE Cascade ON DELETE RESTRICT;
CREATE INDEX vdc_district_code_fk125_ind ON system.vdc (district_code);

ALTER TABLE system.department ADD CONSTRAINT department_office_code_fk126 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX department_office_code_fk126_ind ON system.department (office_code);

ALTER TABLE system.appuser ADD CONSTRAINT appuser_department_code_fk127 
            FOREIGN KEY (department_code) REFERENCES system.department(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX appuser_department_code_fk127_ind ON system.appuser (department_code);

ALTER TABLE system.department ADD CONSTRAINT department_office_code_fk128 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX department_office_code_fk128_ind ON system.department (office_code);

ALTER TABLE administrative.ba_unit ADD CONSTRAINT ba_unit_loc_id_fk129 
            FOREIGN KEY (loc_id) REFERENCES administrative.loc(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_loc_id_fk129_ind ON administrative.ba_unit (loc_id);
...
ALTER TABLE source.source ADD CONSTRAINT source_maintype_fk134 
            FOREIGN KEY (maintype) REFERENCES source.presentation_form_type(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_maintype_fk134_ind ON source.source (maintype);

ALTER TABLE source.source ADD CONSTRAINT source_archive_id_fk135 
            FOREIGN KEY (archive_id) REFERENCES source.archive(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX source_archive_id_fk135_ind ON source.source (archive_id);

ALTER TABLE party.party ADD CONSTRAINT party_office_code_fk136 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_office_code_fk136_ind ON party.party (office_code);

ALTER TABLE administrative.ba_unit ADD CONSTRAINT ba_unit_office_code_fk137 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_office_code_fk137_ind ON administrative.ba_unit (office_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_office_code_fk138 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_office_code_fk138_ind ON cadastre.cadastre_object (office_code);

ALTER TABLE application.application ADD CONSTRAINT application_office_code_fk139 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_office_code_fk139_ind ON application.application (office_code);

ALTER TABLE system.br ADD CONSTRAINT br_office_code_fk140 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_office_code_fk140_ind ON system.br (office_code);

ALTER TABLE system.setting ADD CONSTRAINT setting_office_code_fk141 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX setting_office_code_fk141_ind ON system.setting (office_code);

ALTER TABLE administrative.moth ADD CONSTRAINT moth_office_code_fk142 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX moth_office_code_fk142_ind ON administrative.moth (office_code);

ALTER TABLE administrative.loc ADD CONSTRAINT loc_office_code_fk143 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX loc_office_code_fk143_ind ON administrative.loc (office_code);

ALTER TABLE cadastre.map_sheet ADD CONSTRAINT map_sheet_office_code_fk144 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX map_sheet_office_code_fk144_ind ON cadastre.map_sheet (office_code);

ALTER TABLE transaction.transaction ADD CONSTRAINT transaction_office_code_fk145 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX transaction_office_code_fk145_ind ON transaction.transaction (office_code);

ALTER TABLE address.address ADD CONSTRAINT address_vdc_code_fk146 
            FOREIGN KEY (vdc_code) REFERENCES system.vdc(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX address_vdc_code_fk146_ind ON address.address (vdc_code);

ALTER TABLE party.party ADD CONSTRAINT party_photo_id_fk147 
            FOREIGN KEY (photo_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_photo_id_fk147_ind ON party.party (photo_id);

ALTER TABLE party.party ADD CONSTRAINT party_left_finger_id_fk148 
            FOREIGN KEY (left_finger_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_left_finger_id_fk148_ind ON party.party (left_finger_id);

ALTER TABLE party.party ADD CONSTRAINT party_right_finger_id_fk149 
            FOREIGN KEY (right_finger_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_right_finger_id_fk149_ind ON party.party (right_finger_id);

ALTER TABLE party.party ADD CONSTRAINT party_signature_id_fk150 
            FOREIGN KEY (signature_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_signature_id_fk150_ind ON party.party (signature_id);

ALTER TABLE cadastre.cadastre_object_target ADD CONSTRAINT cadastre_object_target_office_code_fk151 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_target_office_code_fk151_ind ON cadastre.cadastre_object_target (office_code);

ALTER TABLE cadastre.cadastre_contains_tinant ADD CONSTRAINT cadastre_contains_tinant_cadastre_objectid_fk152 
            FOREIGN KEY (cadastre_objectid) REFERENCES cadastre.cadastre_object(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_contains_tinant_cadastre_objectid_fk152_ind ON cadastre.cadastre_contains_tinant (cadastre_objectid);

ALTER TABLE cadastre.cadastre_contains_tinant ADD CONSTRAINT cadastre_contains_tinant_partyid_fk153 
            FOREIGN KEY (partyid) REFERENCES party.party(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_contains_tinant_partyid_fk153_ind ON cadastre.cadastre_contains_tinant (partyid);

ALTER TABLE administrative.ba_unit ADD CONSTRAINT ba_unit_cadastre_object_id_fk154 
            FOREIGN KEY (cadastre_object_id) REFERENCES cadastre.cadastre_object(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_cadastre_object_id_fk154_ind ON administrative.ba_unit (cadastre_object_id);

ALTER TABLE administrative.rrr ADD CONSTRAINT rrr_loc_id_fk155 
            FOREIGN KEY (loc_id) REFERENCES administrative.loc(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX rrr_loc_id_fk155_ind ON administrative.rrr (loc_id);
