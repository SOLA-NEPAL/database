...
ALTER TABLE party.party ADD CONSTRAINT party_office_code_fk134 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_office_code_fk134_ind ON party.party (office_code);

ALTER TABLE administrative.ba_unit ADD CONSTRAINT ba_unit_office_code_fk135 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_office_code_fk135_ind ON administrative.ba_unit (office_code);

ALTER TABLE cadastre.cadastre_object ADD CONSTRAINT cadastre_object_office_code_fk136 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_office_code_fk136_ind ON cadastre.cadastre_object (office_code);

ALTER TABLE application.application ADD CONSTRAINT application_office_code_fk137 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX application_office_code_fk137_ind ON application.application (office_code);

ALTER TABLE system.br ADD CONSTRAINT br_office_code_fk138 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX br_office_code_fk138_ind ON system.br (office_code);

ALTER TABLE system.setting ADD CONSTRAINT setting_office_code_fk139 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX setting_office_code_fk139_ind ON system.setting (office_code);

ALTER TABLE administrative.moth ADD CONSTRAINT moth_office_code_fk140 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX moth_office_code_fk140_ind ON administrative.moth (office_code);

ALTER TABLE administrative.loc ADD CONSTRAINT loc_office_code_fk141 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX loc_office_code_fk141_ind ON administrative.loc (office_code);

ALTER TABLE cadastre.map_sheet ADD CONSTRAINT map_sheet_office_code_fk142 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX map_sheet_office_code_fk142_ind ON cadastre.map_sheet (office_code);

ALTER TABLE transaction.transaction ADD CONSTRAINT transaction_office_code_fk143 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX transaction_office_code_fk143_ind ON transaction.transaction (office_code);

ALTER TABLE address.address ADD CONSTRAINT address_vdc_code_fk144 
            FOREIGN KEY (vdc_code) REFERENCES system.vdc(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX address_vdc_code_fk144_ind ON address.address (vdc_code);

ALTER TABLE party.party ADD CONSTRAINT party_photo_id_fk145 
            FOREIGN KEY (photo_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_photo_id_fk145_ind ON party.party (photo_id);

ALTER TABLE party.party ADD CONSTRAINT party_left_finger_id_fk146 
            FOREIGN KEY (left_finger_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_left_finger_id_fk146_ind ON party.party (left_finger_id);

ALTER TABLE party.party ADD CONSTRAINT party_right_finger_id_fk147 
            FOREIGN KEY (right_finger_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_right_finger_id_fk147_ind ON party.party (right_finger_id);

ALTER TABLE party.party ADD CONSTRAINT party_signature_id_fk148 
            FOREIGN KEY (signature_id) REFERENCES document.document(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX party_signature_id_fk148_ind ON party.party (signature_id);

ALTER TABLE cadastre.cadastre_object_target ADD CONSTRAINT cadastre_object_target_office_code_fk149 
            FOREIGN KEY (office_code) REFERENCES system.office(code) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX cadastre_object_target_office_code_fk149_ind ON cadastre.cadastre_object_target (office_code);

ALTER TABLE administrative.ba_unit ADD CONSTRAINT ba_unit_cadastre_object_id_fk150 
            FOREIGN KEY (cadastre_object_id) REFERENCES cadastre.cadastre_object(id) ON UPDATE CASCADE ON DELETE RESTRICT;
CREATE INDEX ba_unit_cadastre_object_id_fk150_ind ON administrative.ba_unit (cadastre_object_id);

ALTER TABLE administrative.rrr ADD CONSTRAINT rrr_loc_id_fk151 
